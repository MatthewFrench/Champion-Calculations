...
- Generated (local): `2026-02-17 05:14:27 -06:00`
- Generated (UTC): `2026-02-17T11:14:27.211944+00:00`
- Scenario: `Simulation/scenarios/vladimir_urf_teamfight.json`

## Headline
- Best objective score: **0.0961**
- Best time alive / damage dealt / healing done / enemy kills / invulnerable seconds: **3.66s / 4,832.2 / 366.7 / 0 / 2.00s**
...
### Best Build
- Weighted-mean score: `0.0961`
- Worst-case scenario score: `0.0961`
- Worst-case blend weight: `0.35`
- Final blended objective score: `0.0961`
- survival: weight `0.26` | normalized `0.0031` | contribution `0.0008` | impact `0.81%` | delta vs weight `-24.83pp`
- damage: weight `0.13` | normalized `0.2615` | contribution `0.0335` | impact `34.90%` | delta vs weight `+22.08pp`
- healing: weight `0.08` | normalized `0.1363` | contribution `0.0105` | impact `10.91%` | delta vs weight `+3.22pp`
- enemy_kills: weight `0.51` | normalized `0.0000` | contribution `0.0000` | impact `0.00%` | delta vs weight `-51.28pp`
- invulnerable_seconds: weight `0.03` | normalized `2.0000` | contribution `0.0513` | impact `53.37%` | delta vs weight `+50.81pp`
...
- Simulations executed (new full combat runs): `2,374`
- Unique scored candidates (all search stages): `2,374`
- Total score requests (all search stages): `2,374`
- Full evaluations cache hits/misses/waits: `0/2,374/0`
- Full persistent cache hits/entries: `0/2,374`
...
- Search elapsed time: `1.24s`
- Total run time (end-to-end): `1.68s`

- Effective seed: `573753478406407503`
- Time budget: `1.0s`; timed_out: `true`; progress: `0/128` (0.0%)

- Estimated total legal candidate space: `995,424,835,958,784`
- Estimated legal-space coverage (this run): `2.385e-10%`
- Estimated legal-space coverage (persistent cache): `2.385e-10%`
- Estimated closeness probability (top 0.000001% heuristic): `0.00%`
- Closeness probability note: Estimated as P(hit top 0.000001% candidate set) = 1 - (1 - q)^n, with q = 0.000001000% (about top 9954248 candidates in the legal space) and n = 2374 unique scored candidates. This is a conservative random-sampling approximation, not a guarantee.
- Search-type simulation breakdown:
  - seed_search:portfolio: requests `2,374`, new simulations `2,374`, persistent cache hits `0`
...
## Diverse Top Builds
1. `score 0.0961` (+0.0000 vs top): Abyssal Mask, Actualizer, Bloodletter's Curse, Umbral Glaive, Unending Despair, Void Staff | seed hits: 1/1 (100%) robust | Pareto-front
   - metrics: EHP~8,781.0, AP~287.9, timing score -8471.67, total cost 16,950

## Build Order Optimization
1. Cumulative score: `3.29` | Order: Bloodletter's Curse, Unending Despair, Void Staff, Actualizer, Abyssal Mask, Umbral Glaive
   - Stage 1 (level 5): objective `0.504`, time alive `2.06s`, damage `1,373.1`, healing `115.8`
   - Stage 2 (level 8): objective `0.736`, time alive `2.30s`, damage `3,145.1`, healing `207.2`
   - Stage 3 (level 11): objective `0.535`, time alive `3.79s`, damage `4,504.1`, healing `251.3`
   - Stage 4 (level 14): objective `0.520`, time alive `3.78s`, damage `4,909.2`, healing `293.6`
   - Stage 5 (level 17): objective `0.508`, time alive `3.72s`, damage `4,983.1`, healing `343.7`
   - Stage 6 (level 20): objective `0.487`, time alive `3.66s`, damage `4,832.2`, healing `366.7`
