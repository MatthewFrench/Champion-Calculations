...
controlled_champion:
  identity: Vladimir
  core: pos=(0.0, 0.0) hp=4444.5/4444.5 (100.0%) armor=109.5 mr=54.7
  offense: ap=365.7 ah=355.0
  loadout: items [Abyssal Mask, Actualizer, Bloodletter's Curse, Morellonomicon, Rapid Firecannon, Void Staff] | runes [First Strike, Hextech Flashtraption, Triple Tonic, Approach Velocity, Triumph, Legend: Bloodline] | shards [attack_speed, health, tenacity]
  cooldowns: none
  abilities: Q:vladimir_transfusion ready; W:vladimir_sanguine_pool ready; E:vladimir_tides_of_blood ready; R:vladimir_hemoplague ready; Auto Attack 0.38s
...
- 0.000s [damage_in] Morgana Dark Binding -> Vladimir | physical 0.0, magic 1003.7, true 0.0, total 648.8
...
- 0.000s [damage_in] Dr. Mundo Infected Bonesaw -> Vladimir | physical 0.0, magic 858.6, true 0.0, total 555.0
- 0.159s [attack_start] Vayne begins auto attack
- 0.250s [controlled_champion_ultimate_hit] Vladimir vladimir_hemoplague dealt 1880.6 to 5 enemies in range
...
- 0.525s [damage_in] Vayne Auto Attack -> Vladimir | physical 1140.8, magic 0.0, true 0.0, total 544.5
- 0.525s [attack_hit] Vayne hit Vladimir (phys 1140.8, magic 0.0, true 0.0)
- 0.540s [attack_start] Sona begins auto attack
- 0.612s [attack_start] Dr. Mundo begins auto attack
- 0.613s [damage_in] Warwick Auto Attack -> Vladimir | physical 343.2, magic 81.6, true 0.0, total 216.6
- 0.613s [attack_hit] Warwick hit Vladimir (phys 343.2, magic 81.6, true 0.0)
...
- 1.000s [damage_in] Dr. Mundo Infected Bonesaw -> Vladimir | physical 0.0, magic 448.6, true 0.0, total 290.0
...
- 1.041s [damage_in] Vayne Auto Attack -> Vladimir | physical 717.3, magic 0.0, true 0.0, total 342.4
- 1.041s [attack_hit] Vayne hit Vladimir (phys 717.3, magic 0.0, true 0.0)
- 1.183s [attack_start] Vayne begins auto attack
- 1.212s [damage_in] Warwick Auto Attack -> Vladimir | physical 285.8, magic 81.6, true 0.0, total 189.2
- 1.212s [attack_hit] Warwick hit Vladimir (phys 285.8, magic 81.6, true 0.0)
...
- 1.549s [damage_in] Vayne Auto Attack -> Vladimir | physical 685.4, magic 0.0, true 911.3, total 1238.4
- 1.549s [controlled_champion_death] Vladimir died
- 1.549s [attack_hit] Vayne hit Vladimir (phys 685.4, magic 0.0, true 911.3)
