...
controlled_champion:
  identity: Vladimir
  core: pos=(0.0, 0.0) hp=5085.4/5085.4 (100.0%) armor=109.5 mr=54.7
  offense: ap=235.3 ah=353.0
  loadout: items [Abyssal Mask, Actualizer, Bloodthirster, Cryptbloom, Heartsteel, Solstice Sleigh] | runes [Aftershock, Shield Bash, Conditioning, Overgrowth, Presence of Mind, Cut Down] | shards [ability_haste, movement_speed, health]
  cooldowns: none
...
- 0.200s [controlled_champion_primary_hit] Vladimir vladimir_transfusion hit Warwick for 176.2
- 0.250s [controlled_champion_ultimate_hit] Vladimir vladimir_hemoplague dealt 1597.3
- 0.300s [controlled_champion_secondary_hit] Vladimir vladimir_tides_of_blood dealt 1142.8
...
- 2.000s [damage_in] Dr. Mundo Infected Bonesaw -> Vladimir | physical 0.0, magic 1525.6, true 0.0, total 986.2
...
- 2.200s [controlled_champion_primary_hit] Vladimir vladimir_transfusion hit Warwick for 176.2
...
- 2.300s [damage_in] Morgana Dark Binding -> Vladimir | physical 0.0, magic 872.4, true 0.0, total 563.9
- 2.300s [controlled_champion_secondary_hit] Vladimir vladimir_tides_of_blood dealt 1142.8
- 2.315s [attack_start] Dr. Mundo begins auto attack
- 2.370s [damage_in] Warwick Auto Attack -> Vladimir | physical 449.2, magic 81.6, true 0.0, total 267.2
- 2.370s [attack_hit] Warwick hit Vladimir (phys 449.2, magic 81.6, true 0.0)
- 2.470s [damage_in] Vayne Auto Attack -> Vladimir | physical 844.2, magic 0.0, true 0.0, total 403.0
- 2.470s [attack_hit] Vayne hit Vladimir (phys 844.2, magic 0.0, true 0.0)
...
- 2.932s [damage_in] Warwick Auto Attack -> Vladimir | physical 409.0, magic 81.6, true 0.0, total 248.0
- 2.932s [attack_hit] Warwick hit Vladimir (phys 409.0, magic 81.6, true 0.0)
...
- 3.000s [damage_in] Dr. Mundo Infected Bonesaw -> Vladimir | physical 0.0, magic 783.2, true 0.0, total 506.2
- 3.069s [damage_in] Vayne Auto Attack -> Vladimir | physical 1128.6, magic 0.0, true 0.0, total 538.7
- 3.069s [attack_hit] Vayne hit Vladimir (phys 1128.6, magic 0.0, true 0.0)
...
- 3.482s [damage_in] Warwick Auto Attack -> Vladimir | physical 328.4, magic 81.6, true 171.9, total 381.4
- 3.482s [attack_hit] Warwick hit Vladimir (phys 328.4, magic 81.6, true 171.9)
- 3.500s [champion_script] Vayne executed Tumble Empower
- 3.500s [enemy_buff] Vayne empowered next attack
- 3.662s [damage_in] Vayne Auto Attack -> Vladimir | physical 716.5, magic 0.0, true 975.4, total 1317.4
- 3.662s [controlled_champion_death] Vladimir died
- 3.662s [attack_hit] Vayne hit Vladimir (phys 716.5, magic 0.0, true 975.4)
