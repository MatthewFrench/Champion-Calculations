...
- Runes: `Press the Attack, Triumph, Legend: Alacrity, Last Stand, Second Wind, Unflinching`
...
- Trace markdown: `Simulation/output/runs/controlled_champion/fixed_loadout/maximum_quality/600srunecmppresstheattack/vladimir_fixed_loadout_trace.md`
- Trace json: `Simulation/output/runs/controlled_champion/fixed_loadout/maximum_quality/600srunecmppresstheattack/vladimir_fixed_loadout_trace.json`

## Rune Proc Telemetry
- Press the Attack: procs `0` / attempts `16` / eligible `0` (proc/attempt 0.0%, proc/eligible 0.0%), bonus damage `0.00` (0.00% share), bonus healing `0.00` (0.00% share)
  - sources: ability (procs 0, attempts 16, eligible 0, proc/attempt 0.0%, proc/eligible 0.0%, damage 0.00, healing 0.00)
