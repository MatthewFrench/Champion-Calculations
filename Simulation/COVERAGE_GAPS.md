...
24. Keep intended-behavior-first handling for known bug notes; treat any bug-emulation as explicit deferred runtime policy work, not implicit data defaults.
