...
| Runtime loadout stack/cooldown mutation, combat bonus resolution, rune-proc telemetry accumulation, runtime-state initialization/reset, and runtime read-only projections | `scripts/runtime/loadout_runtime.rs`, `scripts/runtime/loadout_runtime/combat_bonus_resolution.rs`, `scripts/runtime/loadout_runtime/combat_bonus_resolution/*`, `scripts/runtime/loadout_runtime/rune_proc_telemetry.rs`, `scripts/runtime/loadout_runtime/runtime_state_initialization.rs`, `scripts/runtime/loadout_runtime/runtime_effect_mutations.rs`, `scripts/runtime/loadout_runtime/runtime_stat_projections.rs`, `scripts/runtime/loadout_runtime/runtime_state_reporting.rs`, and `engine.rs` call sites | `scripts/runtime/loadout_runtime.rs` facade + runtime owner leaves (`combat_bonus_resolution.rs`, `combat_bonus_resolution/*`, `rune_proc_telemetry.rs`, `runtime_state_initialization.rs`, `runtime_effect_mutations.rs`, `runtime_stat_projections.rs`, `runtime_state_reporting.rs`) | Script/runtime owner APIs only (`calculate_*`, `on_*`, `trigger_*`, `loadout_*`, `reset_*`, `build_*`, `rune_proc_telemetry`, `describe_runtime_*`) |
